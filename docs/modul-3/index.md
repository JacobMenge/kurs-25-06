...
| Thema | Beschreibung |
|-------|-------------|
| [Redis](zusatzmaterial/redis/01-redis-grundlagen.md) | Caching mit Redis – Grundlagen, Python/FastAPI, Fullstack, Docker Compose |
| [Authentication](zusatzmaterial/auth/01-auth-konzepte-password-hashing.md) | Auth – Password Hashing, JWT, React Frontend, Fullstack Integration |
